  ...
  onDaySelected(DateTime day, List events, List holidays) {
    ...
    if (wkPreviousDay == day) {
      return showDialog(
        context: context,
        builder: (_) {
          return DayEventDialog(context, day);
        },
      );
    } else {
      wkPreviousDay = day;
                      ...
                      return Padding(
                        ...
                        child: Container(
                          child: DropdownButton<String>(
                            ...
                            autofocus: true,
                            value:
                                ifCalenderList[model.selectedIfCalenderIndex],
              ...
              ? Row(
                  children: [
                    Text(freeFriends[DateTime(day.year, day.month, day.day)]
                        ["name"]),
                    Text(formatter.format(
                            freeFriends[DateTime(day.year, day.month, day.day)]
                                ["start"]) +
                        "〜" +
                        formatter.format(
                            freeFriends[DateTime(day.year, day.month, day.day)]
