    ...
    body:Column(
      children: [
            ...
            decoration: new BoxDecoration(
              ...
              SafeArea(
                child: Align(
                  ...
                  child: FloatingActionButton(child: Icon(Icons.notifications,color: Colors.white,size: 40,),
        ...
        Padding(
          ...
          child: Text("User Name",style: TextStyle(fontSize: 28),),
        ),

          Text("ひとことコメントだよ〜",style: TextStyle(fontSize: 16),),
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Text("新宿駅南口",style: TextStyle(fontSize: 16),),
            ],
          ),
        ),
               ...
               Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                 children:[
                   ...
                   Container(
                     ...
                     child: Column(
                         children: [
                           Icon(Icons.outgoing_mail,size: 40,),
                           Text("遊びに誘う")]
                     ),
                   ),
            ]
